...
<head>
  ...
  <!--
  <link href="https://fonts.googleapis.com/css?family=Oswald&display=swap" rel="stylesheet">--> <!--None preview font-->
  <!--
  <link href="https://fonts.googleapis.com/css?family=Anton&display=swap" rel="stylesheet">--> <!--None preview font-->
  <!--
  <link href="https://fonts.googleapis.com/css2?family=Lalezar&display=swap" rel="stylesheet">--> <!--preview font-->
  <!--
  <link href="https://fonts.googleapis.com/css2?family=Anton&display=swap" rel="stylesheet">--><!--episode name font main menu-->
  <!--custom css-->
...
#title-outter{
  ...
  width: 100%;
  top: 0%;
  background-color: /*#2a202e*/ rgba(20,20,40, 0.87);
  margin-left: 0%;
...
void main(void) {
    ...
    gl_FragColor.a = 1.0;
        ...
        <div class="container-fluid text-light py-3 px-2 uiMenuElement" style="width: 30%;  position: absolute; top:0%; left:0%;">
        ...
        <div class="container box2 py-3 px-2 rounded uiMenuElement" style="width: 400px; position: absolute; top:4%; right:2%;">
          <div class="row px-2">
            <div class="col-2">
            <img src="utilities/storyteller/images/logo.png" width="60" style="filter:grayscale(100%); filter:invert(100%);" class="mr-2">
            </div>
            <div class="col-10 my-auto text-left">
            <div class="mb-2"><span class="font-weight-bold">RESOURCES</span><span class="float-right ml-3">Version 1.0</span></div>
            <div class="progress" style="height: 10px;">
              <div class="progress-bar bg-dark" role="progressbar" style="width: 100%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">Loaded</div>
            </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="row menuButtons bg-white pb-4">
            ...
            <button id="btnStartGame" class="box w-100 font-weight-bold text-center" style="height: 65px;"><img src="utilities/storyteller/images/play.svg" width="30" class="mr-2"><span>START THE GAME</span></button>
            </div>
            
            <div class="col-4 p-0 my-auto">
            
            <button id="btnSet" class="box w-100 font-weight-bold text-center" style="height: 65px;"><img src="utilities/storyteller/images/settings.svg" width="30" style="filter:grayscale(100%);" class="mr-2"> SETTINGS</button>
            </div>

            <div class="col-4 p-0 my-auto">
            
            <button id="btnFullscreen" class="box w-100 font-weight-bold text-center" style="height: 65px;"><img src="utilities/storyteller/images/fullscreen.svg" width="30" style="filter:grayscale(100%);" class="mr-2"> FULL SCREEN</button>
            </div>
          </div>
        </div>

        <div id="menuSettings" class="container box2 py-3 px-2 rounded uiMenuElement" style="width: 400px; position: absolute; bottom:26%; right:2%; display:none;">
          <div class="row px-2">
            ...
            <div class="col-10 my-auto">
              <!--Characters Settings-->
            <div class="mb-2 border-bottom border-dark"><span class="font-weight-bold text-uppercase">Characters Settings</span></div>
            ...
            <div class="mb-2 text-right">
              ...
              <!--Audio Settings-->
            <div class="mb-2 border-bottom border-dark"><span class="font-weight-bold text-uppercase">Audio Settings</span></div>
            ...
            <div class="text-right">
              ...
              <div><label class="mr-2">BGM</label> <input id="range-audioBGM" class="align-middle audioRange" type="range" step="0.1" min="0" max="1" value="1"></div>
              <div><label class="mr-2">Sound Effect</label> <input id="range-audioSoundEffect" class="align-middle audioRange" type="range" step="0.1" min="0" max="1" value="1"></div>
              <div><label class="mr-2">SE Constant</label> <input id="range-audioSoundEffectConstant" class="align-middle audioRange" type="range" step="0.1" min="0" max="1" value="1"></div>
              <div><label class="mr-2">Voice</label> <input id="range-audioVoice" class="align-middle audioRange" type="range" step="0.1" min="0" max="1" value="1"></div>
            </div>
...
<!--Normal Menu-->
<div id="charactersMenu" class="container-fluid h-100 position-fixed bg-menu" style="z-index: 1049; top:0%; display:none">
    <div class="row align-items-center h-100">
        <div class="col h-100 p-0">
          ...
          <div id="charactersOutput" class="col-12 text-center px-5 img-bottom">
            ...
            <div class="row text-center mx-auto text-light mt-3 px-5 w-100" style="bottom:0%; position:absolute;">
...
<div id="settingsMenu" class="container-fluid h-100 position-fixed bg-menu" style="z-index: 1049; top:0%; display:none">
    <div class="row align-items-center h-100">
        <div class="col h-100 p-0">
          <div class="container-fluid py-5 px-0">
          ...
          <div id="settingWorld" class="row mx-auto text-light mt-3 p-0" style="width:100%; min-height:50vh !important; background-attachment: local; background-position: center; background-image:url('');">
...
<div id="dialogueMenu" class="container-fluid h-100 position-fixed bg-menu" style="z-index: 1049; top:0%; display:none; overflow-y:scroll;">
      ...
      <div class="row h-100 bg-black6" id="preview-outter">
        <div class="col p-0" id="divPreview">
          ...
          <div id="dialog-outter">
            ...
            <div id="dialog-button"><img src="utilities/storyteller/images/dialog-button.svg" id="btnNext"></div>
          </div>
          <div id="title-outter">
            ...
            <div class="right">
              <img id="btnPause" src="utilities/storyteller/images/pause.svg" style="cursor: pointer;">
              
              <img id="btnCharacters" src="utilities/storyteller/images/team.svg" style="filter:invert(100%);">
              <img id="btnSettings" src="utilities/storyteller/images/map.svg" style="filter:invert(100%);">
              <img id="btnMusic" src="utilities/storyteller/images/music.svg" style="filter:invert(100%);">
              <img id="btnDialogues" class="mr-2" src="utilities/storyteller/images/dialogues.svg" style="filter:invert(100%);">
